...
//        }
    ...
    private List<String> toConjuncts(List<JdbcColumnHandle> columns, TupleDomain<ColumnHandle> tupleDomain, List<ClickhouseTypeAndValue> accumulator)
    {
    ...
    private String toPredicate(String columnName, Domain domain, Type type, List<ClickhouseTypeAndValue> accumulator)
    {
    ...
    private String toPredicate(String columnName, String operator, Object value, Type type, List<ClickhouseTypeAndValue> accumulator)
    {
        bindValue(value, type, accumulator);
    ...
    private static void bindValue(Object value, Type type, List<ClickhouseTypeAndValue> accumulator)
    {
        checkArgument(isAcceptedType(type), "Can't handle type: %s", type);
        accumulator.add(new ClickhouseTypeAndValue(type, value));
    }
}
